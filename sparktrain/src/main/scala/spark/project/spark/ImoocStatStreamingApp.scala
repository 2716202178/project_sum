package spark.project.spark

import spark.project.dao.{CourseClickCountDAO, CourseSearchClickCountDAO}
import spark.project.domain.{ClickLog, CourseClickCount, CourseSearchClickCount}
import spark.project.utils.DateUtils
